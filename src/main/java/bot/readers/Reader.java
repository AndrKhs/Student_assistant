...
public class Reader implements IReader {
    ...
    @Override
    public String readDeadline(String date, String message, User userDate) throws IOException {
        sb.setLength(0);
        ...
        if (Files.exists(path)) {
            HomeWork deadline = deserializationDeadline(date, userDate, message, sb);
     ...
     * @throws IOException
     */
    private HomeWork deserializationDeadline(String date, User userDate, String message, StringBuilder sb) throws IOException {
        sb.append(userDate.getGroup().group)
                .append("_")
                .append(date)
                .append("_")
                .append(message);
    ...
    @Override
    public Group readGroup(String idUser, AppCommands command) throws IOException {
        sb.setLength(0);
    ...
    @Override
    public User readUserDate(String idUser) throws IOException {
        sb.setLength(0);
    ...
    @Override
    public String readDate(String idUser, AppCommands command) throws IOException {
        sb.setLength(0);
        sb.append(System.getProperty("user.dir")).append("\\TimeDataBase\\").append(idUser).append(command);
        java.io.File file = new java.io.File(sb.toString());
        String date = null;
    ...
    @Override
    public Discipline readDiscipline(String idUser, AppCommands command) throws IOException {
        sb.setLength(0);
        sb.append(System.getProperty("user.dir")).append("\\TimeDataBase\\").append(idUser).append(command);
        java.io.File file = new java.io.File(sb.toString());
