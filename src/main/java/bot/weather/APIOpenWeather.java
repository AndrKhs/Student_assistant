...
public class APIOpenWeather implements WeatherParser {
    ...
    private static String downloadJsonRawData(String city) throws Exception {
        String urlString = AppConstants.API_CALL_TEMPLATE.toStringValue() + city + AppConstants.API_KEY_TEMPLATE.toStringValue();
        URL urlObject = new URL(urlString);

        HttpURLConnection connection = (HttpURLConnection) urlObject.openConnection();
        connection.setRequestMethod("GET");
        connection.setRequestProperty("User-Agent", AppConstants.USER_AGENT.toStringValue());
