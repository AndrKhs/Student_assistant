...
public class OpenWeatherMapJsonParser implements WeatherParser {
    ...
    private final static String API_KEY_TEMPLATE = "&units=metric&APPID=d97a349114c8783aa4c0f7884f74ba63\n";
    ...
    public String getReadyForecast(String city) {
        ...
        try {
            ...
            return String.format("Не могу найти \"%s\" город. Попробуйте другой, например: \"Киев\" или \"Москва\"", city);
        } catch (Exception e) {
            e.printStackTrace();
        ...
        for (String line : weatherList) {
            {
                ...
                try {
                    ...
                    weatherArrNode = objectMapper.readTree(line).get("bot/weather");
